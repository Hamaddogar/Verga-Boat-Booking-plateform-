...
export interface StayDateSingleInputProps {
  className?: string;
...
const StayDateSingleInput: FC<StayDateSingleInputProps> = ({
  className = "",
      ...
      <>
        ...
        <div className="flex-grow text-left">
          ...
          <span className="block mt-1 text-sm text-neutral-400 leading-none font-light">
            {selectsRange ? "Pick up - Drop off" : "Scegli una data"}
          </span>
        </div>
      </>
    );
  ...
  return (
    <>
      <Popover className={`StayDateSingleInput relative flex ${className}`}>
        {({ open }) => (
          <>
            <div
